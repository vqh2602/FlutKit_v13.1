...
import 'package:flutkit/full_apps/shopping_manager/views/login_screen.dart'
    as shopping_manager;
        ...
        return ListView(
          ...
          children: <Widget>[
            ...
            GridView.count(
                ...
                children: <Widget>[
                  SinglePageItem(
                    iconData: Boxicons.bx_book_open,
                    navigation: learning.SplashScreen(),
                    title: "Learning",
                  ),
                  SinglePageItem(
                    iconData: Boxicons.bx_dish,
                    navigation: cookify.SplashScreen(),
                    title: "Cookify",
                  ),
                  SinglePageItem(
                    iconData: Boxicons.bx_heart,
