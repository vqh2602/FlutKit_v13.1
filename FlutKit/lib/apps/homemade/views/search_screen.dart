import 'package:flutkit/apps/homemade/controllers/search_controller.dart';
...
import 'package:flutkit/apps/homemade/models/product.dart';
import 'package:flutkit/apps/homemade/views/single_product_screen.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      FxText.bodySmall("Rs. ${product.price}", fontWeight: 700),
                      FxContainer(
